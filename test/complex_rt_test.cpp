...
BOOST_AUTO_TEST_CASE( test_division_and_modulus )
{
    ...
    typedef complex_rt<rational_type, 0>        real_type;
    typedef complex_rt<rational_type, 1>     complex_type;
    typedef complex_rt<rational_type, 2>  quaternion_type;
    typedef complex_rt<rational_type, 3>    octonion_type;
    ...
    // Floating
    {
    complex_rt<double, 0> const  two = { 2.0 }, five = { 5.0 }, six = { 6.0 };
    complex_rt<double, 1> const  eight_ten = { 8.0,10.0 },one_one = { 1.0,1.0 };
    complex_rt<double, 2> const  primed = { 2.0, 3.0, 5.0, 7.0 },
     squared = { 4.0, 9.0, 25.0, 49.0 };
    complex_rt<double, 3> const  super = { 0.316667, -1.233333, 1.594444,
    ...
    typedef complex_rt<int, 1>     complex_type;
    typedef complex_rt<int, 2>  quaternion_type;
    typedef complex_rt<int, 3>    octonion_type;

    complex_rt<int, 0> const  two = { 2 }, five = { 5 }, six = { 6 };
    complex_rt<int, 1> const  eight_ten = { 8, 10 }, one_one = { 1, 1 };
    complex_rt<int, 2> const  primed = { 2, 3, 5, 7 }, squared = {4, 9, 25, 49};
    complex_rt<long,3> const  super = { 39, -81, 88, 60, -75, -94, -73, 68 },
